...
function displayClusters(clusters) {
    ...
    clusters.forEach((cluster) => {
        ...
        const saturation = avgPriceLevel === null ? 0 : 80; // null の場合は彩度 0
        const lightness = avgPriceLevel === null ? 50 : 50; // 明度は固定

        const colorHSL = Cesium.Color.fromCssColorString(`hsl(${hue}, ${saturation}%, ${lightness}%)`);
